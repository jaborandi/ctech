...
<link rel="shortcut icon" href="{{ asset('images/favicon.png') }}" />
    ...
    <link rel="stylesheet" href="{{ asset('css/material-icons.css') }}" />
        <link rel="stylesheet" href="{{ asset('css/animate.css') }}" />
            <link rel="stylesheet" href="{{ asset('css/bootstrap-default.css') }}" />
                <link rel="stylesheet" href="{{ asset('css/bootstrap-theme-tequila.css') }}" />
                                    ...
                                    <ul class="navbar-nav ml-auto">
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">
                                                ...
                                                <span>Oi <?php echo $user->UserName(); ?></span>
                                            </a>
                                            <ul class="dropdown-menu">
                                                <a class="dropdown-item" href="<?php print_link('account') ?>"><i class="material-icons">account_box</i> Minha conta</a>
                                                <a class="dropdown-item" href="<?php print_link('auth/logout') ?>"><i class="material-icons">exit_to_app</i> Sair</a>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
