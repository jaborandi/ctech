		...
		<div class="col-md-6 col-12">
			<div class="my-5 card-body">
				...
				<div class="row">
					...
					<div class="col">
						<h3 class="text-primary mb-2 font-weight-bold">Verificação OTP</h3>
						<p class="text-muted">
							OTP foi enviado para o seu número de telefone via SMS
						</p>
					</div>
					<div class="col-auto">
				...
				<form method="POST" action="{{ route('auth.validateotp') }}">
					...
					<div class="form-group mb-3">
						<input name="otp_code" type="text" class="form-control otp-input" required autofocus placeholder="Digite OTP">
					</div>
