                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-name-holder" class=" ">
                                                    <input id="ctrl-name"  value="<?php  echo $data['name']; ?>" type="text" placeholder="Entrar Name"  required="" name="name"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-guard_name-holder" class=" ">
                                                    <input id="ctrl-guard_name"  value="<?php  echo $data['guard_name']; ?>" type="text" placeholder="Entrar Guard Name"  required="" name="guard_name"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
