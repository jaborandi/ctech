            ...
            <div class="row ">
                <div class="col-md-9 comp-grid" >
                    ...
                    <div  class=" page-content" >
                        <!--[form-start]-->
                        <form id="agenda_cinema-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="{{ route('agenda_cinema.store') }}" method="post">
                            @csrf
                            <div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div id="ctrl-titulo-holder" class=" "> 
                                        <input id="ctrl-titulo"  value="<?php echo get_value('titulo') ?>" type="text" placeholder="Quem é e qual filme verá?"  name="titulo"  class="form-control " />
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div id="ctrl-observacoes-holder" class=" "> 
                                        <textarea placeholder="Observações pertinentes a esta agenda" id="ctrl-observacoes"  rows="5" name="observacoes" class=" form-control"><?php echo get_value('observacoes') ?></textarea>
