                                    ...
                                    <table class="table table-hover table-striped table-sm text-left">
                                        ...
                                        <tbody class="page-data">
                                            ...
                                            <td class="td-btn">
                                                ...
                                                <?php } ?>
                                                <?php if($can_delete){ ?>
                                                <a class="dropdown-item record-delete-btn" data-prompt-msg="Tem certeza de que deseja excluir este registro?" data-display-style="modal" href="<?php print_link("model_has_roles/delete/$rec_id"); ?>">
                    ...
                    <div class="row justify-content-center">    
                        <div class="col-md-auto justify-content-center">    
                            <div class="p-3 d-flex justify-content-between">    
                                ...
                                " data-display-style="modal" data-url="<?php print_link("model_has_roles/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
