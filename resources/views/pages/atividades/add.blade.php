            ...
            <div class="row ">
                <div class="col-md-9 comp-grid" >
                    ...
                    <div  class=" page-content" >
                        <!--[form-start]-->
                        <form id="atividades-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="{{ route('atividades.store') }}" method="post">
                            @csrf
                            <div>
                                <div class="form-group ">
                                    <label class="control-label" for="titulo">Titulo da atividade </label>
                                    <div id="ctrl-titulo-holder" class=" "> 
                                        <input id="ctrl-titulo"  value="<?php echo get_value('titulo') ?>" type="text" placeholder="Ex: Dinâmica com dinossauros"  name="titulo"  class="form-control " />
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label class="control-label" for="descricao">Descrição e planejamento da atividade </label>
                                    <div id="ctrl-descricao-holder" class=" "> 
                                        <textarea placeholder="Entrar Descrição e planejamento da atividade" id="ctrl-descricao"  rows="5" name="descricao" class="htmleditor form-control"><?php echo get_value('descricao') ?></textarea>
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-6">
                                        ...
                                        <div id="ctrl-disciplina-holder" class=" "> 
                                            ...
                                            <?php
                                                ...
                                                $value = $option['value'];
                                                $label = $option['label'];
                                                $selected = Html::get_field_selected('disciplina', $value);
                                            ?>
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <div id="ctrl-duracao-holder" class=" "> 
                                            <input id="ctrl-duracao"  value="<?php echo get_value('duracao') ?>" type="number" placeholder="Em minutos" step="any"  name="duracao"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    ...
                                    <div id="ctrl-tags-holder" class=" "> 
                                        ...
                                        <option value="">Comece a digitar para procurar</option>
                                        <?php 
                                            $options = $comp_model->tags_option_list() ?? [];
                                            foreach($options as $option){
                                            $value = $option->value;
                                            $label = $option->label ?? $value;
                                            $selected = Html::get_field_selected('tags', $value);
                                        ?>
                                        <option <?php echo $selected; ?> value="<?php echo $value; ?>">
                                        <?php echo $label; ?>
                                        </option>
