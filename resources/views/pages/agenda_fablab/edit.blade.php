...
<?php
    $pageTitle = "Editar Agenda Fablab";
?>
@extends($layout)
                ...
                <div class="col-md-9 comp-grid" >
                    ...
                    <div  class=" page-content" >
                        <div class="row">
                            <div class="col">
                                <!--[form-start]-->
                                <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("agenda_fablab/edit/$rec_id"); ?>" method="post">
                                <!--[form-content-start]-->
                                @csrf
                                <div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div id="ctrl-titulo-holder" class=" "> 
                                            <input id="ctrl-titulo"  value="<?php  echo $data['titulo']; ?>" type="text" placeholder="Quem é o público/o que fará?"  name="titulo"  class="form-control " />
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div id="ctrl-observacoes-holder" class=" "> 
                                            <textarea placeholder="Observações pertinentes a essa agenda" id="ctrl-observacoes"  rows="5" name="observacoes" class=" form-control"><?php  echo $data['observacoes']; ?></textarea>
