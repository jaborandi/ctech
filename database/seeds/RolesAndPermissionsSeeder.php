...
class RolesAndPermissionsSeeder extends Seeder
{
	private $permissionsByRole = [
		...
		'administrador' => [
			'home/list', 'users/list', 'users/view', 'users/add', 'users/store', 'users/edit', 'users/delete', 'users/importdata', 'account/list', 'account/edit', 'atividades/list', 'atividades/view', 'atividades/add', 'atividades/store', 'atividades/edit', 'atividades/delete', 'agenda_fablab/list', 'agenda_fablab/view', 'agenda_fablab/add', 'agenda_fablab/store', 'agenda_fablab/edit', 'agenda_fablab/delete', 'agenda_cinema/list', 'agenda_cinema/view', 'agenda_cinema/add', 'agenda_cinema/store', 'agenda_cinema/edit', 'agenda_cinema/delete', 'compras/list', 'compras/view', 'compras/add', 'compras/store', 'compras/edit', 'compras/delete', 'tarefas/list', 'tarefas/view', 'tarefas/add', 'tarefas/store', 'tarefas/edit', 'tarefas/delete', 'tarefas/atribuidas', 'roles/list', 'roles/view', 'roles/add', 'roles/store', 'roles/edit', 'roles/delete', 'permissions/list', 'permissions/view', 'permissions/add', 'permissions/store', 'permissions/edit', 'permissions/delete', 'model_has_roles/list', 'model_has_roles/view', 'model_has_roles/add', 'model_has_roles/store', 'model_has_roles/edit', 'model_has_roles/delete', 'model_has_permissions/list', 'model_has_permissions/view', 'model_has_permissions/add', 'model_has_permissions/store', 'model_has_permissions/edit', 'model_has_permissions/delete', 'role_has_permissions/list', 'role_has_permissions/view', 'role_has_permissions/add', 'role_has_permissions/store', 'role_has_permissions/edit', 'role_has_permissions/delete', 'tarefas/kanban', 'tarefas/visaotarefas', 'projetos/list', 'projetos/view', 'projetos/add', 'projetos/store', 'projetos/edit', 'projetos/delete', 'agenda_laboratorio/list', 'agenda_laboratorio/view', 'agenda_laboratorio/add', 'agenda_laboratorio/store', 'agenda_laboratorio/edit', 'agenda_laboratorio/delete'
		], 
		'colaborador' => [
			'home/list', 'account/list', 'account/edit', 'atividades/list', 'atividades/view', 'atividades/add', 'atividades/store', 'atividades/edit', 'atividades/delete', 'agenda_fablab/list', 'agenda_fablab/view', 'agenda_fablab/add', 'agenda_fablab/store', 'agenda_fablab/edit', 'agenda_cinema/list', 'agenda_cinema/view', 'agenda_cinema/add', 'agenda_cinema/store', 'agenda_cinema/edit', 'compras/list', 'compras/view', 'compras/add', 'compras/store', 'compras/edit', 'compras/delete', 'tarefas/list', 'tarefas/view', 'tarefas/add', 'tarefas/store', 'tarefas/edit', 'tarefas/delete', 'tarefas/atribuidas', 'tarefas/kanban', 'tarefas/visaotarefas', 'projetos/list', 'projetos/view', 'projetos/add', 'projetos/store', 'projetos/edit', 'projetos/delete', 'agenda_laboratorio/list', 'agenda_laboratorio/view', 'agenda_laboratorio/add', 'agenda_laboratorio/store', 'agenda_laboratorio/edit'
		], 
		'escola' => [
			'home/list', 'agenda_cinema/list', 'agenda_cinema/view', 'agenda_cinema/add', 'agenda_cinema/store', 'agenda_cinema/edit', 'agenda_cinema/importdata', 'agenda_fablab/list', 'agenda_fablab/view', 'agenda_fablab/add', 'agenda_fablab/store', 'agenda_fablab/edit', 'agenda_fablab/importdata', 'atividades/list', 'atividades/view', 'account/list', 'account/edit', 'tarefas/kanban', 'tarefas/visaotarefas', 'agenda_laboratorio/list', 'agenda_laboratorio/view', 'agenda_laboratorio/add', 'agenda_laboratorio/store', 'agenda_laboratorio/edit'
		]
	];
    public function run()
    {
